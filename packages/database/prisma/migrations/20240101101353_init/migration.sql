...
-- AddForeignKey
ALTER TABLE "Expense" ADD CONSTRAINT "Expense_paymentOptionId_fkey" FOREIGN KEY ("paymentOptionId") REFERENCES "PaymentOption"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
