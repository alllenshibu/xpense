...
const Overview = () => {
  return (
    <div className="w-full h-2/5 px-10 py-1 flex flex-row justify-between items-center ">
      <p className="text-5xl font-semibold tracking-wide">21st March</p>
      <div className="h-48 w-96 rounded-xl bg-orange-200 flex flex-col justify-center items-center">
